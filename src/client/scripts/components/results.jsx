    ...
    render: function() {
        ...
        return (
            <section className="results">
                ...
                <p>
                    Devices used to access the internet range from Smart Phones, Tablets, Computers & Laptops. Television and Gaming Consoles are the latest device categories to be used as screens for internet access.
                </p>
            </section>
        );
    }
